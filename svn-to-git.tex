...
%%
%% svn-to-git.tex
%% Crated Fri May 17 14:27:54 AKDT 2019
...
%%
%%\usepackage{svninfo}
%%\svnInfo $Id: svn-to-git.tex 1 2013-02-04 22:32:54Z marcilr $
...
%% Titlepage
%%
%% Got clean titlepage format from:
%%   How can I get a title page with the LaTeX article class? [duplicate]
%%   https://tex.stackexchange.com/questions/36929/\
...
%%  Subversion to Git revision control system
%%  conversion.
%%\end{abstract}
